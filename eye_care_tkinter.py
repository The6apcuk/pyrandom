...
class StartPage(tk.Tk):
    ...
    def start_progress(self, pbar, style):
        ...
        if self.progress_button["text"] == "Launch":
            ...
            # Change the button's text to Restart
            self.progress_button.configure(text="Restart")
            ...
            def wrapper(pbar, style):
                ...
                if pbar["value"] < WORK_TIME and RUNNING:
        ...
        elif self.progress_button["text"] == "Restart":


            pbar["value"] = 0
            style.configure('text.Horizontal.TProgressbar',
                            text='{:0>2g}:{:0>2g}'.format(0, 0))
